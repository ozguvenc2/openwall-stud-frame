...
| [19-phase1-s1-lean-sweep.md](19-phase1-s1-lean-sweep.md) | Phase 1 S1: 25 synthetic dressed 2×4 leans through all six finders. Ranks 1, 2, and 6 pass the stage-0 bars on 25/25. Rank 3, after `CLOUDCOMPARE_EXE` discovery, returns a lean on 25/25 and fails the bars on 25/25 (several faces per stud). Ranks 4 and 5 are controls. Not a field score. |
...
| [22-phase2-wall-corner-field.md](22-phase2-wall-corner-field.md) | Phase 2 painted outside wall-corner plumb pilot. SKIL versus two Open3D planes. Not a stud and not class F. Density ladder for the Lot62 loft exports and the close corner. |
| [23-phase2-corner-neural.md](23-phase2-corner-neural.md) | Synthetic outside corner with planted SKIL-mean leans. Office controls, phase-1 stud heads, and a short 3-class Pointcept head. Not studs. |
...
| 2026-09-25, Oz_PC: phase 2 painted outside wall corner. SKIL face means 0.383° and 0.250°. The same two Open3D planes lean 1.005° and 0.763° from export +Z, and 1.685° and 0.976° from a floor normal used as up. Faces not registered. Not a stud. Write-up: `docs/research/22-phase2-wall-corner-field.md`. The PLY files stay gitignored. | `known` |
| 2026-09-25, Oz_PC: synthetic corner at those SKIL means, then office controls, stud heads, and a 3-class Pointcept head. Two faces were not recovered. Write-up: `docs/research/23-phase2-corner-neural.md`. Not class F. | `known` |
