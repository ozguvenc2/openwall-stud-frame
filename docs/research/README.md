...
| 2026-09-25: one synthetic 2×4 at 0.05° lean was passed through all five finders. Open3D and PCL ran. CloudCompare RANSAC-SD ran and missed the stage 0 bars. Pointcept and Open3D-ML were blocked (no GPU, no weights). Rank 6 is pyRANSAC-3D v0.7.0 sequential cuboid, the add Oz approved from doc 17, on that same stud. Write-up: `docs/research/16-one-stud-five-finder-run.md`. Not a field segmenter. | `known` |
