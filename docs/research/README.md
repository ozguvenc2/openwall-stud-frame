...
| [35-framing-lumber-wood-characteristics.md](35-framing-lumber-wood-characteristics.md) | Framing-lumber characteristics for Track B: bow, crook (spring), twist, cup, crown; mill → truck → Arizona moisture; site culls (wane, checks, splits, knots, slope of grain); grain/texture versus density and center of mass. Survey only. Later product direction, not shipped: meter those deformations beside Stage0 lean (doc 33 Track B). Does not change paint, ε, or docs 31–34 locks. Axis diagram: [diagrams/35-warp-axes.mmd](diagrams/35-warp-axes.mmd). |
...
| 2026-09-26: Framing lumber characteristics (doc 35). Industry warp names and axes, Arizona EMC versus the 15–19% mill target, stud-grade cull language, and an evidence split on grain versus density / center of mass. Cross-links doc 33 Track B. Same note records a later OpenWall offer to meter bow, crook/crown, cup, and twist beside Stage0 lean; that metering is Track B and is not shipped. No paint, ε, or pipeline-lock edit. Write-up: `docs/research/35-framing-lumber-wood-characteristics.md`. | `known; surveyed` |
