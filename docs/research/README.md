...
| [24-sam2-rank7-and-curriculum.md](24-sam2-rank7-and-curriculum.md) | Bake-off rank 7 is SAM 2 (weights not run). Rank 1 through a synthetic room. S1b bow and a 2 mm probe recorded as misses. Ladder figures with stud counts: [images/curriculum/INDEX.md](images/curriculum/INDEX.md). PRs #23 and #24 stay parallel. |
