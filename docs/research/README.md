...
| [21-cloudcompare-stud-param-tune.md](21-cloudcompare-stud-param-tune.md) | Rank 3 follow-up: CloudCompare RANSAC-SD knobs and a face merge so one dressed 2×4 is one box. Before/after on the same 25 S1 scenes. Not a field score. |
...
| 2026-09-25, Oz_PC: rank 3 tune only. Planes merged into one dressed-2×4 box. 25 of 25 stage-0 passes, one box each. Write-up: `docs/research/21-cloudcompare-stud-param-tune.md`. The doc 19 table is still the untuned multi-plane pass. Not a field segmenter. | `known` |
