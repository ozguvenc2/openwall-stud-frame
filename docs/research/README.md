...
| [19-phase1-s1-lean-sweep.md](19-phase1-s1-lean-sweep.md) | Phase 1 S1: 25 synthetic dressed 2×4 leans (magnitude × axis, seed 2) through all six finders. Stage 0 bars on ranks 1, 2, 3, and 6. Ranks 4 and 5 are controls. Not a field score. |
...
| [TruePlank paper space](../../papers/trueplank-stud-lean-qa/README.md) | Publication draft for stud instance detection and lean QA (BeamWeaver / TruePlank / OpenWall). Class S numbers only. Not a submission. |
...
| 2026-09-25, Oz_PC: phase 1 S1 lean sweep, 25 synthetic clouds, six finders. Write-up: `docs/research/19-phase1-s1-lean-sweep.md`. Ranks 4 and 5 stay controls. CloudCompare was not on PATH. The PCL row is the in-process port when the scorecard says the native binary did not run. Not a field segmenter. | `known` |
