...
| [33-obb-and-deformation-research.md](33-obb-and-deformation-research.md) | Track A: minimal OBB vs PCA / MVBB / hull / RANSAC / J-Linkage / region-grow / deep cuboid heads — bake-off top-5. Track B: centerline bow, deviation profiles, ICP-to-CAD, twist. Keep minimal OBB as Stage0 default. Survey only. |
...
| 2026-09-26: OBB / primitive fitting and deformed-plank survey (doc 33). Shared path stays `_obb_segments` → minimal OBB. Track A bake-off top-5 and Track B bow/twist candidates ranked; no new scorecard. Write-up: `docs/research/33-obb-and-deformation-research.md`. | `known; surveyed` |
