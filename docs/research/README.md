...
| [23-phase2-neural-corner.md](23-phase2-neural-corner.md) | Synthetic outside wall corner (two planes, not studs) through ranks 4 and 5. Planted leans are the SKIL face means. Not the painted field cloud. |
...
| 2026-09-25, Oz_PC: ranks 4 and 5 on a synthetic outside wall corner (planes, not studs). Write-up: `docs/research/23-phase2-neural-corner.md`. The painted field cloud is a separate pass. | `known` |
