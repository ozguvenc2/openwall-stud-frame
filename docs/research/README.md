...
| 2026-09-25, Oz_PC: phase 2 painted outside wall corner. SKIL face means 0.383° and 0.250°. Two Open3D planes lean 1.003° and 0.763° from export +Z. Faces not registered. Not a stud. Write-up: `docs/research/22-phase2-wall-corner-field.md`. The PLY files stay gitignored. | `known` |
