...
Stage 5 synthetic room, rank 1: 532,301 points, 26 studs, precision 1, recall 1, section 7.93 mm, length 22.12 mm, MAE 0.01134°, max angle 0.04230°, yellow, floor normal. The first write-up recorded 1.9151 s. The lock re-run kept those figures and stored 0.9466 s in the scorecard JSON. Corner air gap 0.10 m. No header. Not the Lot 62 Polycam file (that file is PR #24). No stage-5 acceptance bar is declared from this row. Ranks 2–7 on the room are `not_run`. Stages 6 and 7 are stubs with null metrics.
