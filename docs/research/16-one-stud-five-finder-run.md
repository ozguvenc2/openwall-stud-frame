...
**Reclassification (2026-09-26).** This note’s rank numbers stay. Live buckets are [27-four-way-tool-classification.md](27-four-way-tool-classification.md). Former bake-off rank 3 = CloudCompare, now bucket 4 (interactive GUI). The CloudCompare row below ran. It is an archive measurement, not a geometry-first automated finder.
