...
`run_phase1_s1_lean_sweep.py` is experiment phase one (S1): 25 synthetic dressed 2×4 clouds (lean magnitudes 0, 0.05, 0.12, 0.15, 0.30, 1, and 4 degrees; nonzero leans about +X, −X, +Y, and −Y; seed 2). It scores ranks 1, 2, 3, and 6 on every cloud and runs ranks 4 and 5 as controls. Scorecards go to `artifacts/scorecards/phase1_s1/`. The note is `docs/research/19-phase1-s1-lean-sweep.md`. It is not a field measurement.
