...
| E-P2 | Painted outside wall corner. SKIL on two faces. Two Open3D planes. Up is the floor normal. Not a stud | wall plumb pilot | **Run** 2026-09-25, Oz_PC. Not class F. `docs/research/22-phase2-wall-corner-field.md`. Scorecards `artifacts/scorecards/phase2_wall_corner/` (`floor_gravity.json`). PLY gitignored |
